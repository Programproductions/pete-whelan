...
export const portfolioNodes: PortfolioNode[] = [
  ...
  },
  {
    ...
    detail:
      'Select contract architecture work spanning voice AI, legal assistants, and cloud platform modernisation.',
    tags: ['companies'],
  },
  {
    id: 'aimi',
  ...
  {
    id: 'sage-chatbot',
    label: 'Sage Therapeutic Chatbot',
    type: 'project',
  ...
  {
    id: 'legal-voice-apps',
    label: 'Legal Assistant Voice Apps',
    type: 'project',
    summary: 'Voice-first legal assistant applications.',
    detail:
      'Alexa-era legal assistant voice applications — conversational UX, intent design and production voice deployments.',
    tags: ['projects', 'ai'],
  },
  {
    id: 'voice-ai-pioneer',
  ...
  },
  {
    ...
    detail: 'React, TypeScript and modern component architecture for SaaS products.',
    tags: ['skills'],
  },
  {
    id: 'nodejs',
  ...
  },
  {
    ...
    detail: 'End-to-end TypeScript for frontends, APIs and shared domain models.',
    tags: ['skills'],
  },
  {
    id: 'openai',
...
export const portfolioEdges: PortfolioEdge[] = [
  ...
  { source: 'pete-whelan', target: 'legal-voice-apps', label: 'built' },
  ...
  { source: 'aimi', target: 'typescript', label: 'stack' },
