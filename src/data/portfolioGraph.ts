...
const portfolioNodesRaw: PortfolioNode[] = [
  ...
  },
  {
    ...
    label: 'Tautsec',
    type: 'project',
    summary: 'Cyber insurance and protection platform for Australian SMBs.',
    detail:
      'Tautsec Cyber Protect — Cyber Pilot assessments, AI risk analysis, scoring and insurance-ready workflows on GCP for Tautsec Pty Ltd, delivered with Web4 and Program Productions.',
    keyPoints: [
      'Cyber Pilot assessment journeys for SMBs',
      'AI-assisted risk evidence and scoring',
      'Insurance and compliance-aligned outcomes',
      'GCP · Identity Platform · Terraform · data & AI stack',
    ],
    tags: ['projects', 'ai', 'cloud'],
    featured: true,
    earthbancRelevance:
