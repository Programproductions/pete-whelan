...
const portfolioNodesRaw: PortfolioNode[] = [
  ...
  },
  {
    ...
    label: 'AIMI Platform',
    type: 'company',
    summary: 'Client — creator royalties and disputes platform (pilot).',
    detail:
      'Organisation behind aimi.app — guided creator workflows for identity, catalogue intake, discrepancy detection and dispute handoff.',
  ...
  },
  {
    ...
    label: 'AIMI',
    type: 'project',
    summary: 'Creator-focused portfolio and disputes workflow with AI-assisted triage.',
    detail:
      'A modular platform where creators move through guided workflows for identity, works intake, discrepancy detection, and evidence-led handoff.',
    keyPoints: [
      'Reduces manual catalog-risk work through guided flow design',
      'Improves rights confidence via structured catalog + dispute logic',
      'Supports scalable AI assistance for routing, detection, and escalation',
    ],
    tags: ['projects', 'ai', 'cloud'],
    earthbancRelevance:
      'Structured dispute and catalog workflows with audit-friendly handoffs — applicable to regulated data products.',
  },
  {
    id: 'tautsec',
    label: 'Tautsec',
